...
we hope to discriminate between potential landing sites on a level other than just topology.
However, topology will be the \textit{principal} way of determining the safety of a landing site,
...
The real world data will serve as a final testing set, which will give a notion of how well
